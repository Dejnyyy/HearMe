    ...
    <>
      {isMobile ? (
        ...
        <>
          <div className="introduction-box border mt-10 border-yellow-300 p-4 mx-10 md:mx-20 rounded-lg text-white text-center shadow-lg">
            <p className="font-mono text-lg">
              My name is Dejny and I'm an IT student from the Czech Republic. This project is my school work that started 1st of September 2023 and ended 10th of June 2024.
            </p>
          </div>
          <div className="introduction-box border mt-10 border-yellow-300 p-4 mx-10 md:mx-20 rounded-lg text-white text-center shadow-lg">
            <p className="font-mono text-lg">
