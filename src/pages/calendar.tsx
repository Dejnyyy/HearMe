...
const Calendar: React.FC = () => {
  ...
  const formatDate = (dateString: string) => {
    ...
    return formattedDate.replace(',', ', '); // Adding spaces after comma
  };
            ...
            <div style={{ maxHeight: '80vh', overflowY: 'auto' }}>
              {votes.length === 0 ? (
                <div className="text-center justify-center items-center">
                  ...
                  <p className="text-white text-2xl cursor-pointer text-center underline m-auto" onClick={handleNoVotesClick}>Vote</p>
                </div>
              ) : (
                <ul>
