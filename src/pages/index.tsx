...
import { getStaticProps as fetchUsers } from '../queries/najdiUsery'; // Update the path accordingly
...
export const getStaticProps: GetStaticProps = async () => {
  await fetchUsers({}); // Pass an empty object as the argument to fetchUsers.
  // You may return props here if needed
  return {
    props: {
